    ...
    try {
      ...
      if (!registrations || registrations.length === 0) {
        toast({
          ...
          description: "Email is not registered. Please register first.",
          variant: "destructive"
        });
        return;
      }
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Alert>
                  <AlertDescription>
                    Make sure the email matches the one used during registration.
                  </AlertDescription>
                </Alert>
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="pt-6">
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  <li>• Make sure the email matches the one used during registration</li>
                  <li>• Contact admin if you have trouble accessing</li>
                </ul>
              </CardContent>
            </Card>
          </div>
